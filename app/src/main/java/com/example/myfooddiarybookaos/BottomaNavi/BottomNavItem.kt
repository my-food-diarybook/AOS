...
sealed class BottomNavItem(
    ...
    object TimeLine : BottomNavItem(MainScreen.TimeLine.name,MainIcon.timeLineIcon, MainScreen.TimeLine.name)
    ...
    object MyAccount : BottomNavItem(MainScreen.MyAccount.name,MainIcon.myAccountIcon, MainScreen.MyAccount.name)
}
